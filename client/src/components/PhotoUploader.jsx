      ...
      <div className='mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
        {addedPhotos.length > 0 && addedPhotos.map(link => (
          <div className='h-32 flex relative' key={link}> 
            <img className='rounded-2xl w-full object-cover' src={`http://localhost:4000/uploads/${link}`} alt="uploaded" />
        ...
        <label className='h-32 cursor-pointer flex justify-center gap-2 border bg-transparent rounded-2xl p-8 text-2xl text-gray-600'>
